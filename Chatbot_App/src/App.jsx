  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to ChatBot Dashboard!</h1>
        <p className="text-gray-600">Authentication successful. Chat functionality coming soon...</p>
      </div>
    </div>
  )
}
